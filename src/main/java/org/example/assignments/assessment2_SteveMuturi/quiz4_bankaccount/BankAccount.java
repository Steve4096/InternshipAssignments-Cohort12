...
public class BankAccount {
    ...
    public void setAccountNumber(String accountNumber) {
        if(accountNumber==null || accountNumber.trim().isEmpty()) throw new RuntimeException("Account number can't be null or empty");
        this.accountNumber = accountNumber;
    }

    public void setAccountHolder(String accountHolder) {
        if(accountHolder==null || accountHolder.trim().isEmpty()) throw new RuntimeException("Account holder must be explicitly set.");
